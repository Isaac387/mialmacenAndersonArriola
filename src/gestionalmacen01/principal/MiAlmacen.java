...
public class MiAlmacen {
	...
	private static void borrar() {
		...
		if (almacen.borrarProducto(codigo)) {
			...
			System.out.println("el producto no es correcto o no existe.");
		}
	}
	...
	private static void modificarPrecio() {
		...
		System.out.println("dime el codigo reyy!!!: ");
		int codigo = leerEntero();
		...
		if (p != null) {
			...
			float newPrecio = leerFloat();
			p.setPrecio(newPrecio);
		} else {
			System.out.println("el producto o el codigo esta mal");
		}
	}
	...
	private static void comprar() {
		...
		int cantidad_a_comprar = leerEntero();

		Producto p = almacen.buscarProducto(codigo);

		if (p != null && p.getStock() >= cantidad_a_comprar) {
			System.out.println("has comprado la cantidad de: " + cantidad_a_comprar + " de: " + p.getNombre());
			p.setStock((p.getStock() - cantidad_a_comprar));
		} else {
			System.out.println("el producto no existe o no hay stock.");
		}
	...
	private static void listar() {
		...
		for (Producto p : almacen.obtenerProductos()) {
	...
	private static void listarPocoStock() {
		...
		for (Producto p : almacen.obtenerProductosStockMin()) {
			System.out.println(p);
		}
	}
	...
	private static void crear() {
		...
		System.out.println("dime el codigo para tu nuevo producto.");
		int codigo = leerEntero();
		System.out.println("dime el nombre: ");
		String nombre = sc.nextLine();
		Producto p = new Producto(codigo,nombre);
		System.out.println("dime el stock que vamos a tener");
		int stockNuevoProducto = leerEntero();
		p.setStock(stockNuevoProducto);
		System.out.println("tendra stock minimo di SI/NO");
		String hayStockMin = sc.nextLine().toUpperCase();
		if (hayStockMin.equals("SI")) {
